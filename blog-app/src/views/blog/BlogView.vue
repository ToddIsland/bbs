      ...
      <el-main>
        ...
        <div class="me-view-card">
          ...
          <div style="padding-left: 290px">
            <el-button @click="change()" type="primary" v-bind:plain=admired?false:true>赞 {{article.admireCounts}}
            </el-button>
          </div>
          ...
          <div class="me-view-tag">
            板块：
            <el-button size="mini" type="primary" round plain>{{article.category.categoryname}}</el-button>
          </div>
    ...
    methods: {
      ...
      deleteArticle() {
        deleteArticle(this.article.id).then(() => {
            ...
            this.$message({message: '删帖成功 请继续浏览', type: 'success', showClose: true})//消息提示
          }).catch(error => {
            if(error!='error'){
