...
public class ArticleServiceImpl implements ArticleService {
    ...
    @Override
    public List<Article> listArticles(ArticleVo article, PageVo page,Integer id) {
        return articleRepository.listArticles(article, page);
    }
    ...
    @Override
    public List<Article> listMoyuArticles(ArticleVo article, PageVo page){
        return articleRepository.findOrderByCreateDateMoyuArticles();
    }
